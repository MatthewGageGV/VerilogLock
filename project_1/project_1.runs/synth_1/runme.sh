...
HD_PWD='C:/Users/BERRINGB/Desktop/VerilogLock/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_Keypad_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LCD_Keypad_Top.tcl
