...
HD_PWD='C:/Users/BERRINGB/Desktop/VerilogLock/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_Keypad_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LCD_Keypad_Top.tcl -notrace
